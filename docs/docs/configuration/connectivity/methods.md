...
Open **Show connection details** from the header in the Headendarr frontend, then use the **Client Connection Wizard** button.
The wizard guides you through the best-recommended connection options for your selected client.

You can still copy playlist, HDHomeRun, XMLTV, XC, or TVHeadend endpoint details directly from the same panel for manual setup.

[![Show connection details dropdown with Client Connection Wizard button](/img/screenshots/show-connection-details-dropdown-connection-wizzard-button.png)](/img/screenshots/show-connection-details-dropdown-connection-wizzard-button.png)
:::
...
- **Emby**: By adding each per-source playlist as a separate tuner, you can ensure you don't exceed connection limits from any single provider.
...
:::tip Easy Copy
Use the **Client Connection Wizard** in the **Show connection details** dropdown for guided client-specific recommendations.

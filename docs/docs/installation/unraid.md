...
Installing TIC on Unraid is straightforward using the Community Applications plugin.
...
2.  In the search box, type `TVH-IPTV-Config` and press Enter.
...
| **WebUI**               | The default is `http://[IP]:[PORT:9985]`. This link will take you to the TIC web interface.                                                                                                                |
| **Port: 9985 (TCP)**    | **TIC Web UI**: The main interface for the application.                                                                                                                                                   |
...
Once the container is running, you can access the TIC Web UI by clicking the container's icon and selecting **WebUI**. The URL will be `http://<your-unraid-ip>:9985`.

        ...
        <div
          ...
          <q-card flat>
            <q-card-section :class="$q.platform.is.mobile ? 'q-px-none' : ''">
              <TicListToolbar
                :add-action="{label: 'Add Source', icon: 'add'}"
                :search="{label: 'Search sources', placeholder: 'Name, URL, type...'}"
                :search-value="searchQuery"
                @add="openPlaylistSettings(null)"
...
import {TicConfirmDialog, TicListActions, TicListToolbar, TicResponsiveHelp} from 'components/ui';
